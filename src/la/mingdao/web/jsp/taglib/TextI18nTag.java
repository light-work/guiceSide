...
import la.mingdao.common.UserInfo;
import la.mingdao.common.UserSession;
import la.mingdao.common.UserSessionException;
 ...
 * @since JDK1.5
 */
public class TextI18nTag extends BaseTag {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            if (locale.getLanguage().equals("zh")) {
                resourceBundle = userInfo.getZhCNResourceBundle();
            } else if (locale.getLanguage().equals("en")) {
                resourceBundle = userInfo.getEnUSResourceBundle();
            }
            if (resourceBundle == null) {
                resourceBundle = ResourceBundle.getBundle("message", locale);
                if (locale.getLanguage().equals("zh")) {
                    userInfo.setZhCNResourceBundle(resourceBundle);
                } else if (locale.getLanguage().equals("en")) {
                    userInfo.setEnUSResourceBundle(resourceBundle);
                }
            }
