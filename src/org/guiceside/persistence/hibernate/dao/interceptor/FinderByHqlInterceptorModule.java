...
/**
 ...
 QQ:(119582291)
 **/
public class FinderByHqlInterceptorModule extends AbstractInterceptorStrategy{
	...
	public MethodInterceptor getMethodInterceptor() {
		return new FinderByHqlInterceptor();
	}

	public Matcher<? super Method> getMethodMatcher() {
		return Matchers.annotatedWith(FinderByHql.class);
	}
