...
/**
 ...
 QQ:(119582291)
 **/
public class QueryByHqlInterceptorModule extends AbstractInterceptorStrategy{
	...
	public MethodInterceptor getMethodInterceptor() {
		return new QueryByHqlInterceptor();
	}

	public Matcher<? super Method> getMethodMatcher() {
		return Matchers.annotatedWith(QueryByHql.class);
	}
