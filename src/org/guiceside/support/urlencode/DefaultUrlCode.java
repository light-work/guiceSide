 ...
 * 
 */
public class DefaultUrlCode implements UrlCode{

	/**
	 * 码表
	 */

    private final static String CODEC_TABLE = "acdefhijklmnoqrstuvwxyz123456789";
	/**
	 * 表示5bit的字节
	 */
	 ...
	 * @return (编码/加密)后的字符串
	 */
	public  String encode(String keys) {
	 ...
	 * @return (编码/加密)后的字符串
	 */
	public  String encode(String keys, String characterSet) {
	 ...
	 * @return (编码/加密)后的字符串
	 */
	private  String encode(byte[] keyBytes) {
		...
		for (int i = 0; i < keyBytes.length; i++) {
			FormatUtils.formatBinary(keyBytes[i], mergrd);
	 ...
	 * @return (解码/解密)后的字符串
	 */
	public  String decode(String code, String characterSet) {
		...
		for (int i = 0; i < code.length(); i++) {
			...
			FormatUtils.formatBinary(indexBinary, sbBinarys, FIVE_BIT);
	 ...
	 */
	private  int getCodecTableIndex(char code) {
